...
export class Modal {
  constructor(options) {
    ...
    window.setTimeout(this.watchMouse.bind(this), 2000);
  }
  open() {
    let hideCookie = crumbs.get(this.options.cookie_name); // Get cookie
    if (hideCookie) return;
    window.dataLayer.push({ event: "exit_lightbox_display" });
  ...
  close(e) {
    window.dataLayer.push({ event: "exit_lightbox_closed" });
    e.preventDefault();
  ...
  success() {
    window.dataLayer.push({ event: "exit_lightbox_submit" });
    let form = document.querySelector("#" + this.overlayID + " form");
  ...
  loadTranslation(lang) {
    switch (lang) {
      // United Kingdom
      case "UK":
        this.options.heading_top = "before you go";
        this.options.heading_bottom = "stay in the know";
        ...
        this.options.first_name = "First Name";
        this.options.last_name = "Last Name";
        this.options.email = "Email Address";
      ...
      case "NL":
        ...
        this.options.first_name = "Voornaam";
        this.options.last_name = "Achternaam";
        this.options.email = "E-mailadres";
      ...
      case "FR":
        ...
        this.options.first_name = "Prénom";
        this.options.last_name = "Nom";
        this.options.email = "Adresse e-mail";
      ...
      case "DE":
        ...
        this.options.first_name = "Vorname";
        this.options.last_name = "Nachname";
        this.options.email = "E-Mail-Adresse";
